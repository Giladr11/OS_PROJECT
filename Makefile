...
HANDLE_CHECKSUMS_SRC = $(SRC_DIR)/$(BOOT_DIR)/$(STAGE2_DIR)/$(INCLUDE_DIR)/handleChecksums.asm
## Kernel Source Files:
...
# Compile loader.bin
$(LOADER_BIN): $(LOADER_SRC) $(GDT_SRC) $(A20_SRC) $(INITPM_SRC) $(CRC32_SRC) $(HANDLE_CHECKSUMS_SRC) $(PRINT16_SRC)
